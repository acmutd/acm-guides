    ...
    return (
        ...
        >
            <div className="flex items-start justify-between gap-3">
                ...
                {badge && (
                    <span
                        className="shrink-0 rounded-full bg-pink-500/10 px-2 py-0.5 text-[10px] font-bold uppercase tracking-wider text-pink-600 dark:bg-pink-500/20 dark:text-pink-200">
            {badge}
          </span>
                )}
            </div>
        ...
        <span
            className="text-[10px] font-bold uppercase tracking-widest text-zinc-400 group-hover:text-zinc-900 dark:text-white/40 dark:group-hover:text-white transition-colors">
          Open →
        </span>
            </div>
        </Link>
...
export default function Home() {
    ...
    return (
        <main
            className="relative h-screen w-full overflow-hidden bg-zinc-50 text-zinc-900 font-sans selection:bg-pink-500/30 dark:bg-black dark:text-white transition-colors duration-300">
          ...
          dark:bg-[radial-gradient(circle_at_center,transparent_0%,rgba(0,0,0,0.8)_100%)]"
            ...
            <div className="relative z-10 flex h-full flex-col justify-between px-6 py-12 md:px-12">
                <div className="flex flex-1 flex-col items-center justify-center">
                    ...
                    <div className="mb-6 animate-in fade-in slide-in-from-top-4 duration-700">
                        <div
                            className="inline-flex items-center gap-2 rounded-full border border-zinc-300 bg-white/80 px-4 py-1.5 backdrop-blur-md shadow-sm dark:border-white/20 dark:bg-white/10 dark:shadow-[0_0_20px_rgba(255,255,255,0.1)]">
              <span className="relative flex h-2 w-2">
                ...
                <span className="relative inline-flex rounded-full h-2 w-2 bg-green-600"></span>
                            ...
                            <span
                                className="text-xs font-bold tracking-[0.2em] uppercase text-zinc-800 dark:text-white/90">
                powered by ACM dev
              </span>
                        </div>
                    </div>

                    <div className="background-container z-10 flex w-full max-w-3xl flex-col items-center gap-y-4 rounded-3xl
            ...
            dark:border-white/10 dark:bg-gray-600/10 dark:shadow-none transition-all duration-300">
                        ...
                        <p className="mt-6 max-w-xl text-center text-xl text-zinc-700 font-medium leading-relaxed animate-in fade-in slide-in-from-bottom-4 duration-700 delay-200 dark:text-zinc-300">
                            ...
                            built by{" "}
                            <span
                                className="text-black decoration-purple-500 underline underline-offset-4 dark:text-white">
                students
              </span>
                            , for{" "}
                            <span
                                className="text-black decoration-blue-500 underline underline-offset-4 dark:text-white">
                students
              </span>
                            .
                        </p>
                        ...
                        <div
                            className="mt-6 flex flex-col sm:flex-row items-stretch sm:items-center gap-4 animate-in fade-in slide-in-from-bottom-8 duration-700 delay-300">
                            <Link
                                to="/docs/workshops"
