                ...
                <>
                    <div className="mx-0 max-w-12xl px-6 md:px-12">
                        <div className="flex h-20 items-center justify-between">
                            <Link to="/" className="group flex items-center gap-2 bg-black px-2 py-2 rounded">
                                <img
                            ...
                            <div className="hidden md:flex items-center gap-1">
                                ...
                                <a
                                    ...
                                    target="_blank"
                                    rel="noreferrer"
                                    className="ml-2 rounded-full border border-zinc-200 bg-white px-4 py-2 text-[11px] font-black uppercase tracking-widest text-zinc-500 hover:bg-zinc-50 hover:text-zinc-900 dark:border-white/10 dark:bg-white/5 dark:text-white/80 dark:hover:bg-white/10 dark:hover:text-white transition-all"
                                >
                                    github
                                </a>
                            ...
                            <div className="md:hidden">
                                <Disclosure.Button
                                    className="inline-flex items-center justify-center rounded-full border border-zinc-200 bg-zinc-50 p-2 text-zinc-900 hover:bg-zinc-100 dark:border-white/10 dark:bg-white/5 dark:text-white dark:hover:bg-white/10 transition-all">
                    ...
                    <Disclosure.Panel
                        className="md:hidden bg-white/90 backdrop-blur-xl border-t border-zinc-200 dark:bg-black/70 dark:border-white/10">
