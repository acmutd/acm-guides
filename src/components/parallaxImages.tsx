...
const ParallaxImages: React.FC = () => {
  ...
  `;
    ...
    return (
        <div
            className="pointer-events-none fixed inset-0 overflow-hidden transition-colors duration-500 bg-zinc-50 dark:bg-black">
            <style>{styles}</style>
            ...
            {/*
      */}
            <div className="absolute -left-[10%] -top-[10%] w-[50vw] h-[50vw] rounded-full blur-3xl z-0
        ...
        dark:bg-[radial-gradient(circle,rgba(129,53,218,0.25)_0%,transparent_70%)]"
            ...
            <div className="absolute -right-[10%] top-[20%] w-[40vw] h-[40vw] rounded-full blur-3xl z-0
        ...
        dark:bg-[radial-gradient(circle,rgba(58,218,176,0.15)_0%,transparent_70%)]"
            ...
            <div className="absolute left-[30%] -bottom-[20%] w-[60vw] h-[60vw] rounded-full blur-3xl z-0
        ...
        dark:bg-[radial-gradient(circle,rgba(227,158,52,0.15)_0%,transparent_70%)]"
            ...
            <div
                className="parallax-layer peechi absolute z-20 right-[12%] top-[15%] transition-transform duration-1000 ease-out">
                <img
